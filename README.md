...
* [nvim](https://github.com/nvim-lua/kickstart.nvim)
* [SketchBar](https://github.com/FelixKratz/SketchyBar)
...
[GNU Stow](https://www.gnu.org/software/stow/) is a symlink farm manager, which means it helps you store all your configuration files in one common location.
